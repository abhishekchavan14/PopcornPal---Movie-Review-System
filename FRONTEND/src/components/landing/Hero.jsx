...
export default function Hero() {
  return (
    <>
    <div className="hidden xl:block fixed w-[70%] h-full bg-[#1e1e1e] z-[-1] border-r" style={{transform: 'skew(20deg,0deg)', left:-200} }>
      <img src={BigLogo} alt="logo" className="absolute right-[20%] top-[10%] h-[70%] w-auto" style={{transform: 'skew(-20deg,0deg)'}}/>
    </div>
    ...
    <video src={BackgroundVideo} autoPlay muted loop className="absolute inset-0 w-full h-full object-cover z-[-2] opacity-80"></video>
    </>
  )
}
